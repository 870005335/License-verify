package com.secretty.core.helper;
...
import com.secretty.core.model.store.CustomKeyStoreParam;
...
public class ParamInitHelper {
    ...
    /**
     * <p>初始化证书生成参数</p>
     * @param param LicenseCreatorParam 生成证书参数
     * @return LicenseParam 证书参数
     */
    public static LicenseParam initLicenseParam(LicenseCreatorParam param) {
        Preferences preferences = Preferences.userNodeForPackage(LicenseCreatorManager.class);
        // 设置对证书内容加密的秘钥
        CipherParam cipherParam = new DefaultCipherParam(param.getStorePass());
        KeyStoreParam privateStoreParam = new CustomKeyStoreParam(LicenseCreatorManager.class
